...
export default function Navbar() {
  ...
  return (
    <div className="bg-white sticky top-0 z-50 shadow-md">
      ...
      <nav className="bg-[#dc3545] border-t border-b border-[#c82333]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hidden md:flex items-center space-x-1 overflow-x-auto whitespace-nowrap scrollbar-hide py-0">
            ...
            <Link href="/" className="text-white hover:bg-[#c82333] px-3 py-3 text-sm font-bold uppercase transition-colors">PETA</Link>
        ...
        {isOpen && (
          <div className="md:hidden bg-[#dc3545] border-t border-[#c82333]">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link href="/" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-bold text-white hover:bg-[#c82333] uppercase">PETA</Link>
      ...
      {/* Marquee */}
      <div className="bg-gray-100 border-b border-gray-200 py-1.5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <marquee className="text-xs font-semibold text-gray-700" scrollamount="4">
